Shader "GPUSkinning/GPUSkinning_Specular_Skin4"
{
    Properties
    {
		...
		[HideInInspector] _SrcBlend ("__src", Float) = 0.5
...
ENDCG
    ...
    CGPROGRAM
        ...
        #pragma surface surfSpecular StandardSpecular vertex:myvert finalcolor:finalSpecular fullforwardshadows aplha// Opaque or Cutout
        ...
        {
   // p.Albedo = tex2D(_MainTex, IN.uv_MainTex).rgb;
         //  p.Alpha = tex2D(_MainTex, IN.uv_MainTex).a;
